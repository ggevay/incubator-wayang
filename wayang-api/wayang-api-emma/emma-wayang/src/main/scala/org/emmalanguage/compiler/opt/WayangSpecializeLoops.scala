...
private[opt] trait WayangSpecializeLoops {
  self: WayangCompiler =>

  import API.DataBag
  import Core.{Lang => core}
  import WayangAPI.Ntv
  import UniverseImplicits._

  private[opt] object WayangSpecializeLoops {

    /**
     * Specializes `while` loops as a `WayangNtv.repeat` calls whenever possible.
     *
     ...
     * body of the loop should consist exclusively of `DataBag` API operators
